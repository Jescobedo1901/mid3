...
void unit_test1(int inputs, char *arg[]);
...
void unit_test1(int inputs, char *arg[])
{
//Create a unit test with tolerance passed in  
    //default tolerance
    double tol = .01;
    //test for inputs, if no input, give default
    if (inputs < 2) {
		cout << "No input was detected.                  \n";
		cout << "                                        \n";
		cout << "Program testing usage: ./program <tolerance>\n";
		cout << "(default tolerance will be displayed)      \n";
	}
	if (inputs > 1) {
		tol = atof(arg[1]);
    }
	...
	//formatting
    cout << "\nunit test running...\n" << endl;
    cout << setw(11) << left << fixed << setprecision(5);
    cout << "mass";
    cout << setw(11) << left << fixed << setprecision(5);
    cout << "height";
    cout << setw(11) << left << fixed << setprecision(5);
    ...
    //input unit_test data MASS HEIGHT PONDERAL
    double arr[] = {135.000000,	50.000000,	13.572088,        
    ...
    while (arr[i] != (-1)) {
        ...
        cout << setw(11) << left << fixed << setprecision(5);
        //double getPonderal(double mass, double height)
        ret = getPonderal(arr[i-2], arr[i-1]);
        cout << ret;
        //14.25941 - 14.24941
        //14.48744 - 14.47744
        if ((arr[i] - ret) >= tol) {
